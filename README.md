...
"Uma _invariante de laço_ é um conjunto de propriedades que:
...
O objetivo de um *invariante de laço* é determinar um método que permita concluir se ao final de um laço o algoritmo está correto ou não.  
