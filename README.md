...
2.  No capítulo 2 será abordado dois tipos de algoritmos de ordenação, para ilustrar o conceito de eficiênica <img alt="formula" src="https://render.githubusercontent.com/render/math?math=a_i" /> = 2
