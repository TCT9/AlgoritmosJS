...
2.  No capítulo 2 será abordado dois tipos de algoritmos de ordenação, para ilustrar o conceito de eficiênica ![formula](https://render.githubusercontent.com/render/math?math=c_1*n^2)
